...
export const career = [
 {
  ...
  {
    year: "1989",
    rank: "MESLEĞE BAŞLANGIÇ",
    title: "DENİZCİLİKTE İLK GÜN",
...
export const gallery = [
  { id: 0, type: "photo", src: images.foto26 },
  { id: 1, type: "photo", src: images.foto28 },
...
export const contributors = [
  ...
  { id: 2, name: "İBRAHİM ÖZNUR" },
  { id: 3, name: "ERAY ÖZGÜNEŞLİ" },
  { id: 4, name: "AHMET OKKİRMAN" },
  { id: 5, name: "ALPAY ACAR" },
  { id: 6, name: "MUHAMMET KİRAZ" },
  { id: 7, name: "ÖMER ADİL UZUNOĞLU" },
  { id: 8, name: "KAMİL KAVRUK" },
  { id: 9, name: "MEHMET KASAR" },
  { id: 10, name: "BAYRAM KOCABEKİR" },
  { id: 11, name: "MEHMET ÖZER ÇALIŞKAN" },
  { id: 12, name: "ALPER KIZILLAR" },
  { id: 13, name: "MUSA YORGANCI" },
  { id: 14, name: "KADİR KARINCALI" },
  { id: 15, name: "İSMAİL ALPASLAN" },
  { id: 16, name: "FATİH KILIÇ" },
  { id: 17, name: "MUHAMMET ÇENGELCİ" },
  { id: 18, name: "ADEM ÜNAL" },
  { id: 19, name: "İLKER KÜLAÇLIOĞLU" },
  { id: 20, name: "HAKAN KOTEL" },
  { id: 21, name: "MURAT GÜLERYÜZ" },
  { id: 22, name: "ALPEREN KARAOĞLU" },
  { id: 23, name: "HAVUZ 13 K'LIĞI" },
  { id: 24, name: "ERBİL ULUTAŞ" },
  { id: 25, name: "ALİ AYKANAT" },
  { id: 26, name: "GÖKHAN GÜNEŞ" },
  { id: 27, name: "ORHAN ÜNER" },
